  ...
  bench = {
    ...
    in {
      ...
      config = {
          ...
          init-bench = {
            ...
            in ''
              ...
              ${
                ...
                (app: "if [[ ! -d \"$FRAPPE_BENCH_ROOT/apps/${app.pname}\" ]]; then git clone ${app.src.gitRepoUrl} \"$FRAPPE_BENCH_ROOT/apps/${app.pname}\"; fi;\n")
                cfg.apps
              }
        ...
        devshell.packages = lib.flatten (lib.catAttrs "packages" cfg.apps);
