            ...
            emplace-files = {
              text =
                ...
                ''
                  ...
                  [[ ! -f "$PRJ_DATA_HOME/sites/common_site_config.json" ]] &&  echo "{\"redis_cache\": \"redis://127.0.0.1:13311\", \"redis_queue\": \"redis://127.0.0.1:11311\", \"developer_mode\": 1}" > "$PRJ_DATA_HOME/sites/common_site_config.json"
                '';
